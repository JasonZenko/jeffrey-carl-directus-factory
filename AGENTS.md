...
This project is indexed by GitNexus as **jeffrey-carl-directus-factory** (1370 symbols, 3172 relationships, 94 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
