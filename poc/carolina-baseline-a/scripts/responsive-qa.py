...
FROZEN_HOME = [
    "main_hero_standard", "icon_feature_cards", "feature_image_content",
    "icon_feature_cards", "highlight_snippet_quote", "feature_image_content",
    "contact_info_standard",
]
    ...
    with sync_playwright() as playwright:
        ...
        for name, viewport in VIEWPORTS.items():
            ...
            checks = {
                ...
                "approved_homepage_composition": evidence["blockSequence"] == FROZEN_HOME,
